...
import { Shard, ShardState } from './Shard.js';
/**
...
export class ShardManager extends EventEmitter {
     ...
     */
    async spawnShard(id, totalShards) {
    ...
    getStatus() {
        ...
        const connectingShards = shardStatuses.filter(s => s.state === ShardState.CONNECTING ||
            s.state === ShardState.IDENTIFYING ||
            s.state === ShardState.RESUMING).length;
     ...
     */
    async processSpawnQueue(totalShards) {
