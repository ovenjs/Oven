...
import { GatewayOpcodes, GatewayCloseCodes } from '@ovenjs/types';
...
export class Shard extends EventEmitter {
     ...
     */
    async disconnect(code = 1000, reason = 'Requested') {
        this.clearTimeouts();
        if (this.heartbeat) {
     ...
     */
    handleHello(data) {
        const interval = ms(data.heartbeat_interval);
        // Setup heartbeat
