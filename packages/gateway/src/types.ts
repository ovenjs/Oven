 ...
 */
export type EventHandler<TEvent extends string, TArgs extends any[] = any[]> = (
  ...args: TArgs
) => void | Promise<void>;
 ...
 */
export type GatewayEventPayload<TEvent extends GatewayDispatchEvents> = Extract<
  GatewayDispatchPayload,
  { t: TEvent }
>['d'];
...
export type WebSocketManagerEventHandler<TEvent extends keyof WebSocketManagerEvents> = (
  ...args: WebSocketManagerEvents[TEvent]
) => void | Promise<void>;
...
export type WebSocketShardEventHandler<TEvent extends keyof WebSocketShardEvents> = (
  ...args: WebSocketShardEvents[TEvent]
) => void | Promise<void>;
 ...
 * @template TEvent - The event name
 */
export type isGatewayEvent<TEvent extends string> = TEvent extends GatewayDispatchEvents
  ? true
  : false;
...
export type WebSocketManagerEvents = {
   ...
   */
  GUILD_MEMBER_REMOVE: [
    payload: GatewayEventPayload<GatewayDispatchEvents.GuildMemberRemove>,
  ];
   ...
   */
  GUILD_MEMBER_UPDATE: [
    payload: GatewayEventPayload<GatewayDispatchEvents.GuildMemberUpdate>,
  ];
   ...
   */
  GUILD_MEMBERS_CHUNK: [
    payload: GatewayEventPayload<GatewayDispatchEvents.GuildMembersChunk>,
  ];
   ...
   */
  GUILD_ROLE_CREATE: [
    payload: GatewayEventPayload<GatewayDispatchEvents.GuildRoleCreate>,
  ];
   ...
   */
  GUILD_ROLE_UPDATE: [
    payload: GatewayEventPayload<GatewayDispatchEvents.GuildRoleUpdate>,
  ];
   ...
   */
  GUILD_ROLE_DELETE: [
    payload: GatewayEventPayload<GatewayDispatchEvents.GuildRoleDelete>,
  ];
   ...
   */
  CHANNEL_PINS_UPDATE: [
    payload: GatewayEventPayload<GatewayDispatchEvents.ChannelPinsUpdate>,
  ];
   ...
   */
  MESSAGE_DELETE_BULK: [
    payload: GatewayEventPayload<GatewayDispatchEvents.MessageDeleteBulk>,
  ];
  ...
  MESSAGE_REACTION_ADD: [
    payload: GatewayEventPayload<GatewayDispatchEvents.MessageReactionAdd>,
  ];
  ...
  MESSAGE_REACTION_REMOVE: [
    payload: GatewayEventPayload<GatewayDispatchEvents.MessageReactionRemove>,
  ];
  ...
  MESSAGE_REACTION_REMOVE_ALL: [
    payload: GatewayEventPayload<GatewayDispatchEvents.MessageReactionRemoveAll>,
  ];
  ...
  MESSAGE_REACTION_REMOVE_EMOJI: [
    payload: GatewayEventPayload<GatewayDispatchEvents.MessageReactionRemoveEmoji>,
  ];
   ...
   */
  VOICE_STATE_UPDATE: [
    payload: GatewayEventPayload<GatewayDispatchEvents.VoiceStateUpdate>,
  ];
   ...
   */
  VOICE_SERVER_UPDATE: [
    payload: GatewayEventPayload<GatewayDispatchEvents.VoiceServerUpdate>,
  ];
   ...
   */
  INTERACTION_CREATE: [
    payload: GatewayEventPayload<GatewayDispatchEvents.InteractionCreate>,
  ];
  ...
  THREAD_MEMBERS_UPDATE: [
    payload: GatewayEventPayload<GatewayDispatchEvents.ThreadMembersUpdate>,
  ];
  ...
  THREAD_MEMBER_UPDATE: [
    payload: GatewayEventPayload<GatewayDispatchEvents.ThreadMemberUpdate>,
  ];
  ...
  STAGE_INSTANCE_CREATE: [
    payload: GatewayEventPayload<GatewayDispatchEvents.StageInstanceCreate>,
  ];
  ...
  STAGE_INSTANCE_UPDATE: [
    payload: GatewayEventPayload<GatewayDispatchEvents.StageInstanceUpdate>,
  ];
  ...
  STAGE_INSTANCE_DELETE: [
    payload: GatewayEventPayload<GatewayDispatchEvents.StageInstanceDelete>,
  ];
